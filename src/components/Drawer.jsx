...
export default function Drawer({
  ...
  return <group position={position}>
    <MelaminePanel position={[geometry.front.position.xCm / 100, geometry.front.position.yCm / 100, geometry.front.position.zCm / 100]} dimensions={[geometry.front.dimensions.widthCm / 100, geometry.front.dimensions.depthCm / 100, geometry.front.dimensions.heightCm / 100]} piece={manufactured.frontPiece} orientation="front" color={MELAMINE} showEdges={showEdges} highlighted={highlighted(ids?.front)} />
    <MelaminePanel position={[geometry.leftSide.position.xCm / 100, geometry.leftSide.position.yCm / 100, geometry.leftSide.position.zCm / 100]} dimensions={[geometry.leftSide.dimensions.heightCm / 100, geometry.leftSide.dimensions.widthCm / 100, geometry.leftSide.dimensions.depthCm / 100]} piece={manufactured.sideLeftPiece} orientation="side" color={MELAMINE} showEdges={showEdges} highlighted={highlighted(ids?.leftSide)} />
    <MelaminePanel position={[geometry.rightSide.position.xCm / 100, geometry.rightSide.position.yCm / 100, geometry.rightSide.position.zCm / 100]} dimensions={[geometry.rightSide.dimensions.heightCm / 100, geometry.rightSide.dimensions.widthCm / 100, geometry.rightSide.dimensions.depthCm / 100]} piece={manufactured.sideRightPiece} orientation="side" color={MELAMINE} showEdges={showEdges} highlighted={highlighted(ids?.rightSide)} />
    <MelaminePanel position={[geometry.back.position.xCm / 100, geometry.back.position.yCm / 100, geometry.back.position.zCm / 100]} dimensions={[geometry.back.dimensions.widthCm / 100, geometry.back.dimensions.depthCm / 100, geometry.back.dimensions.heightCm / 100]} piece={manufactured.backPiece} orientation="front" color={MELAMINE} showEdges={showEdges} highlighted={highlighted(ids?.back)} />
